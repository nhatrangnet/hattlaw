<div class="block">
    <div class="block-title">
      <h5><i class="fa fa-search"></i>{{ trans('form.list') }} Tag</h5><hr>
    </div>
...
<div class="block">
    <div class="block-title">
        ...
        <a href="{{ route('admin.tag.create')}}" class="btn btn-info float-right d-inline">{{ trans('form.create')}}</a>
      <hr>
    </div>
    <div class="block-form">
    <table class="table table-striped table-hover table-sm table-primary" id="admin_tag_table">
        <thead class="thead-blue">
            <tr>
                <th>Id</th>
                <th>{{ trans('form.name') }}</th>
                <th>{{ trans('form.status') }}</th>
                <th>{{ trans('form.number') }} {{ trans('menu.news.name') }}</th>
