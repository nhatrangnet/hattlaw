...
<div class="block">
    <div class="block-title">
      <h5><i class="fa fa-search"></i> {{ config('constant.form.search') }}{{ trans('menu.product.name') }}</h5><hr>
    </div>
...
<div class="block">
    <div class="block-title">
        <h4 class="d-inline"><i class="fa fa-list"></i> {{ trans('form.list') }} {{ trans('menu.product.name') }}</h4>
        <a href="{{ route('admin.product.create')}}" class="btn btn-info float-right d-inline">{{ trans('form.create')}}</a>
      <hr>
    </div>
    <div class="block-form">
