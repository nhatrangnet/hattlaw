<div class="block">
    ...
    <div class="block-form">
        {!!Form::open(array('url'=>'#','method' => 'post','name' => 'frm','id'=>'admins_search_form','class' => 'form-horizontal form-bordered form-inline form-admin')) !!}
          <div class="form-row align-items-center justify-content-center w-100">
            <div class="form-group row">
                ...
                @if(!empty($role_user))
                <div class="col-auto">
                    {{ Form::select('role_search', $role_search, $role_user, array_merge(['id' => 'role_search', 'class' => 'custom-select'] )) }}
                </div>
                @endif
...
<div class="block">
    <div class="block-title">
      ...
      <a href="{{ route('admin.create')}}" class="btn btn-info float-right d-inline">{{ trans('form.create')}}</a>
      <hr>
    </div>
    <div class="block-form">
    <table class="table table-striped table-hover table-sm table-primary" id="admins_list_table">
