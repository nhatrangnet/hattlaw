<div class="block">
    <div class="block-title">
      <h5><i class="fa fa-search"></i>{{ trans('form.list') }} Review</h5><hr>
    </div>
    <div class="block-form d-none">
        {!!Form::open(array('url'=>'#','method' => 'post','name' => 'frm','id'=>'admin-tag-search-form','class' => 'form-horizontal form-bordered form-inline form-admin')) !!}
...
<div class="block">
    <div class="block-title">
        <h4 class=" d-inline"><i class="fa fa-list"></i> {{ trans('form.list') }} Tag</h4>
        <a href="{{ route('admin.reviews.create')}}" class="btn btn-info float-right d-inline">{{ trans('form.create')}}</a>
      <hr>
    </div>
    <div class="block-form">

    <table class="table table-striped table-hover table-sm table-primary" id="admin_review_table">
        <thead class="thead-blue">
            <tr>
                <th>Id</th>
                <th>Name</th>
                <th style="max-width: 200px; overflow:hidden">Text</th>
                <th>Rating</th>
