...
<div class="block">
    <div class="block-title">
      ...
      <a href="{{ route('admin.role.create')}}" class="btn btn-info float-right d-inline">{{ trans('form.create')}}</a>
      {{-- @endif --}}
      <hr>
    </div>
    <div class="block-form">
    <table class="table table-striped table-hover table-sm table-primary" id="admin_role_table">
