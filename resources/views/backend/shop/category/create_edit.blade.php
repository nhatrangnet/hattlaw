<div class="block">
    ...
    <div class="block-form">
		...
		{!!Form::open(['route'=>'admin.product-category.store','name' => 'frm','id'=>'category-create-form','class' => 'form-horizontal form-bordered form-validation disable_multi_submit','enctype' => 'multipart/form-data' ]) !!}
		@else
		{!! Form::model($category, ['method' => 'PATCH', 'action' => ['Backend\Shop\CategoryController@update', $category['id']],'id'=>'category-create-form', 'class' => 'form-horizontal form-bordered form-validation disable_multi_submit','enctype' => 'multipart/form-data']) !!}
		...
		{{-- @csrf --}}
			<div class="form-row">
				...
				<div class="col-md-6 mb-2">
				{{ Form::label(trans('form.pacategory'), null, ['class' => 'control-label']) }}
				...
				<div class="col-md-6 mb-2">
					<div class="card">
						...
						<div class="card-body text-center">
							<img src="{{ $category['old_cover']?? url('images/basic/no_image.png') }}" class="img-fluid" alt="cover">
						</div>
