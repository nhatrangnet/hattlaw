...
<div class="block">
    <div class="block-title">
        <h4 class=" d-inline"><i class="fa fa-list"></i> {{ trans('form.list') }} {{ trans('menu.brand.name') }}</h4>
        <a href="{{ route('admin.brand.create')}}" class="btn btn-info float-right d-inline">{{ trans('form.create')}}</a>
      <hr>
    </div>
    <div class="block-form">
    <table class="table table-striped table-hover table-sm table-primary" id="brand_table">
